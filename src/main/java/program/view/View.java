    ...
    public void active() {
        ...
        switch (act) {
            ...
            case 3:
                ...
                switch (form) {
                    case 1:
                        controller.saveFileparams(pathAndName, params, "y", enumFormat.CSV.toString().toUpperCase());
                        System.out.println("Данные перезаписанны\n");
                        hello();
                    case 2:
                        System.out.println("Сохранить оба файла y/n");
                        String saverXMl = in.nextLine();
                        controller.saveFileparams(pathAndName, params.trim(), saverXMl, enumFormat.XML.toString().toUpperCase());
                        System.out.println("Файл в формате .xml был успешно создан!\n");
                        hello();
                    case 3:
                        System.out.println("Сохранить оба файла y/n");
                        String saverJSON = in.nextLine();
                        controller.saveFileparams(pathAndName, params, saverJSON, enumFormat.JSON.toString().toUpperCase());
            ...
            case 5:
                ...
                controller.changePersonParams(id, par);
            ...
            case 6:
                ...
                dbConnectController.addPersonToDB(personHelper.showOnePerson(paramet.substring(0, 2)));
                personHelper.showAllPersons();
                hello();
            ...
            case 10:
                ...
                System.out.println("id   name           way       USD");
                controller.changePersonParams(updatePers, newParamsForDB);
