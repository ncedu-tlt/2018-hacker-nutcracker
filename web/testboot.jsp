    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Поиск персон</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Показать персон</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Удалить персону</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Создать персону</a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- Page Content -->
<div class="container">
    <h1 class="mt-5">Тут потом будет что то о песонах наверное</h1>
